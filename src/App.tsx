...
const App = () => {
  ...
  return (
    <div className='flex flex-row items-start justify-center min-h-screen gap-5'>
      ...
      <div className="py-2 flex w-full md:w-3/4 lg:w-1/2 h-full min-h-0">
        <Tabs defaultValue="account" className="h-full w-full">
              ...
              <div className="flex flex-col justify-start w-full">
                ...
                `}>
                  ...
                  <div className="w-full md:w-1/3 flex flex-col md:gap-1 break-words">
                    ...
                    <a href="https://www.linkedin.com/in/dhanixblue" target="_blank" className="text-xs underline flex items-center gap-1"><Link className="h-3 w-3 shrink-0"/>linkedin.com/in/dhanixblue</a>
                  </div>

                  {/* Profile */}
                  <div className="w-full md:w-2/3 flex flex-col gap-1">
                    <p className="text-xs font-bold text-blue-900">Profile</p>
                    <p className="text-xs">For over a decade, Dan has worked in the IT industry developing software applications across a wide range of
                      backend and frontend technologies. He is a full-stack developer with experience in requirement analysis,
                      UI design and integration, API development with unit and integration testing, database design, and deployment.
                      His experience working on diverse projects using various technologies and frameworks has shaped his ability
                  ...
                  <div className="w-full md:w-1/3 flex flex-col gap-1 md:pr-5">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-1">
                      <div>
                        ...
                        <p className="text-xs flex items-center gap-1"><Component className="h-2 w-2 shrink-0" />VueJs</p>
                        <p className="text-xs flex items-center gap-1"><Component className="h-2 w-2 shrink-0" />QuasarJs</p>
                        <p className="text-xs flex items-center gap-1"><Component className="h-2 w-2 shrink-0" />ReactJs</p>
                        <p className="text-xs flex items-center gap-1"><Component className="h-2 w-2 shrink-0" />NextJs</p>
                        <p className="text-xs flex items-center gap-1"><Component className="h-2 w-2 shrink-0" />Shadcn</p>
                        <p className="text-xs flex items-center gap-1"><Component className="h-2 w-2 shrink-0" />Tailwind</p>
                      </div>

                      <div>
                        <p className="text-xs flex items-center gap-1"><Component className="h-2 w-2 shrink-0" />Express</p>
                        <p className="text-xs flex items-center gap-1"><Component className="h-2 w-2 shrink-0" />Restify</p>
                        <p className="text-xs flex items-center gap-1"><Component className="h-2 w-2 shrink-0" />Loopback</p>
                        <p className="text-xs flex items-center gap-1"><Component className="h-2 w-2 shrink-0" />NestJs</p>
                        <p className="text-xs flex items-center gap-1"><Component className="h-2 w-2 shrink-0" />Java SE</p>
                        <p className="text-xs flex items-center gap-1"><Component className="h-2 w-2 shrink-0" />PHP</p>
                        <p className="text-xs flex items-center gap-1"><Component className="h-2 w-2 shrink-0" />Python</p>
                        <p className="text-xs flex items-center gap-1"><Component className="h-2 w-2 shrink-0" />Django</p>
                      </div>

                      <div>
                        <p className="text-xs flex items-center gap-1"><Component className="h-2 w-2 shrink-0" />Firebase</p>
                        <p className="text-xs flex items-center gap-1"><Component className="h-2 w-2 shrink-0" />Bull</p>
                        <p className="text-xs flex items-center gap-1"><Component className="h-2 w-2 shrink-0" />Sinon</p>
                        <p className="text-xs flex items-center gap-1"><Component className="h-2 w-2 shrink-0" />Mocha</p>
          ...
          <TabsContent value="projects" className="h-full">
            <Card className="border-0 shadow-none md:border md:shadow-sm flex flex-row p-2 gap-4 justify-between items-start h-full w-full">
      ...
      <div className="hidden md:flex md:w-auto h-full items-start justify-start flex-1 px-2">
        <Calendar
          mode="single"
          selected={date}
          onSelect={setDate}
